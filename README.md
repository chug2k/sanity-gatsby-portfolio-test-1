# sanity-gatsby-portfolio-test-1
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/y80wjp3x/settings/api) and create a token with read rights.
